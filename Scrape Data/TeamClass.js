...
class TeamGraph {
  ...
  addTeam(teamName) {
    if (!this.teams[teamName]) {
      this.teams.push(new Team(String(teamName)));
    }
  }
...
// nouveauGraph.addMatch("Manchester United", "Manchester City", 0, 4);
// nouveauGraph.addMatch("Manchester City", "Manchester United", 2, 0);
